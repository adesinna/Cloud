...
FARGATE_PROFILE_NAME="test1-fargate"
FARGATE_NAMESPACE="fargate" # Namespace to use for Fargate
...
# List the Fargate profiles in the cluster
echo "Listing Fargate profiles in the cluster..."
...
echo "EKS cluster with private node group and Fargate profile setup complete."
